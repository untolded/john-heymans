    ...
    <main className={`brief ${geist.variable} ${archivo.variable} ${shoulders.variable} ${bricolage.variable}`}>
      <div className="brief-inner">
        ...
        <div className="brief-foot">
          ...
          <span>
            <span style={{ display: "inline-flex", gap: "1rem" }}><Link href="/archive/concept-a">Concept A</Link><Link href="/archive/concept-b">Concept B</Link><Link href="/archive/concept-c">Concept C</Link></span>
          </span>
        </div>
      </div>
    </main>
